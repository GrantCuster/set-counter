...
class NumberInput extends Component {
  ...
  changer(new_value) {
    ...
    if (this.props.update_array !== undefined) {
      let updated_array = this.props.update_array.slice()
      updated_array[this.props.update_index][this.props.update_key] = new_value
      this.props.handleChange({ [this.props.update_array_key]: updated_array })
    } else {
